...
export type TError400 = Record<
  EnumError400,
  ErrorCustomEntity & { statusCode: HttpStatus.BAD_REQUEST }
>;
export type TError401 = Record<
  EnumError401,
  ErrorCustomEntity & { statusCode: HttpStatus.UNAUTHORIZED }
>;
export type TError403 = Record<
  EnumError403,
  ErrorCustomEntity & { statusCode: HttpStatus.FORBIDDEN }
>;
export type TError404 = Record<
  EnumError404,
  ErrorCustomEntity & { statusCode: HttpStatus.NOT_FOUND }
>;
export type TError409 = Record<
  EnumError409,
  ErrorCustomEntity & { statusCode: HttpStatus.CONFLICT }
>;
export type TError500 = Record<
  EnumError500,
  ErrorCustomEntity & { statusCode: HttpStatus.INTERNAL_SERVER_ERROR }
>;
